        ...
        <div className="flex-1">
          <div className="bg-white rounded-lg shadow">
            <div className="grid grid-cols-7 gap-px bg-gray-200">
              ...
              {calendarDays.map((day, index) => (<div key={index} className={`bg-white p-2 min-h-[100px] ${day.isCurrentMonth ? 'text-gray-900' : 'text-gray-400'}`}>
                  <div className="font-medium mb-1">{day.day || ''}</div>
                  {day.isCurrentMonth && day.day > 0 && getEventsForDate(day.day).map(event => (<div key={event.id} className={`text-xs p-1 mb-1 rounded ${event.type === 'meeting'
                    ? 'bg-blue-100 text-blue-800'
                    : event.type === 'deadline'
                        ? 'bg-red-100 text-red-800'
        ...
        <div className="w-80">
          <div className="bg-white rounded-lg shadow p-6">
            ...
            <div className="space-y-4">
              {events.map(event => (<div key={event.id} className="border-l-4 border-blue-500 pl-4 py-2">
                  ...
                  <div className="mt-1 space-y-1">
                    ...
                    {event.participants && (<div className="flex items-center text-sm text-gray-500">
