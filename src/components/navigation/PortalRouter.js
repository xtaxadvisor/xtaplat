...
const ClientPortal = React.lazy(() => import('../../pages/client/ClientPortal').catch(() => ({ default: () => _jsx("div", { children: "Client Portal not found" }) })));
const ProfessionalPortal = React.lazy(() => import('../../pages/professional/ProfessionalPortal').catch(() => ({ default: () => _jsx("div", { children: "Professional Portal not found" }) })));
...
const MessagingPortal = React.lazy(() => import('../../pages/messaging/MessagingPortal').catch(() => ({ default: () => _jsx("div", { children: "Messaging Portal not found" }) })));
