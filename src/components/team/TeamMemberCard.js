...
=======
    return (<div className={`bg-white rounded-xl shadow-lg overflow-hidden transform transition-all duration-300 hover:-translate-y-1 hover:shadow-xl ${className}`}>
      <div className="aspect-w-1 aspect-h-1 relative">
        <img src={image} alt={`${name} - ${role}`} className="w-full h-64 object-cover" onError={handleImageError}/>
