...
export function TeamMemberForm({ initialData, onSubmit, onCancel }) {
    ...
    return (<form onSubmit={handleSubmit} className="space-y-6">
      ...
      <Input label="Profile Image URL" value={formData.image} onChange={(e) => setFormData({ ...formData, image: e.target.value })} placeholder="https://example.com/image.jpg" required/>
