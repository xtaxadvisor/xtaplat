...
export function AnalyticsDashboard() {
    ...
    const { metrics, revenueData, clientGrowth, isLoading, exportAnalytics } = useAnalytics(timeRange);
    if (isLoading) {
