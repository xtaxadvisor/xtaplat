        ...
        <div className="bg-white rounded-xl shadow-lg overflow-hidden">
          ...
          <div className="p-8">
            ...
            <div className="flex flex-wrap gap-2 mb-6">
              {video.tags.map((tag, index) => (<span key={index} className="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-blue-100 text-blue-800">
                  <Tag className="h-4 w-4 mr-1"/>
                  {tag}
                </span>))}
            </div>

            <Button variant="primary" className="w-full mb-8" onClick={handlePurchase} icon={Play}>
              Purchase Course
            </Button>
